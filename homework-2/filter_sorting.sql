...
SELECT DISTINCT ship_city, ship_country FROM orders -- ЧТОБ БЫЛО КАК В СКРИНШОТЕ
...
-- 4. минимальную и максимальную цену среди продуктов, не снятых с продажи (таблица products, колонки unit_price,  не равно 1)
